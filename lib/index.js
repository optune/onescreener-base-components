...
const MediaSmall = '(max-width: 736px)';
const MediaMobile = '(max-width: 480px)';
const NotMediaSmall = '(min-width: 736px)';
const NotMediaMobile = '(min-width: 481px)';

// Colors
const ColorHaiti = '#0A0F2C';
const ColorHarlequin = '#27E200';
const ColorBlue = '#005AE2';
const ColorBlueRGB = '74,144,226';
const ColorLightGrey = '#D6D3CF';
const ColorStormGray = '#4F4F4F';
const ColorWhite = '#FFFFFF';
const ColorLightGreySecond = '#DADDE5';
const DEFAULT_DEGREE = 20; // Color Theme
...
const BackgroundColor = {
  ...
  selected: ColorBlue,
  selectedGradient: (degree = DEFAULT_DEGREE) => `linear-gradient(${degree}deg, ${ColorBlue} 61.46%, rgba(${ColorBlueRGB},0.5) 100%)`
};
...
const LogoImage = styled.img`
  ...
  orientation,
  size
}) => orientation === 'LANDSCAPE' ? css(["width:", ";"], LogoSizePortrait[size]) : css(["width:", ";"], LogoSizePortrait[size])}
  }
  ...
  orientation,
  size
}) => isPreviewMobile && css(["width:", ";"], LogoSizePortrait[size]) || orientation === 'LANDSCAPE' && css(["width:", ";"], LogoSizeLandscape[size]) || css(["height:", ";"], LogoSizeLandscape[size])}
  }
`;
const Logo = ({
  logo,
...
const SpotifyPlayer = ({
  ...
  return /*#__PURE__*/React.createElement(Player, null, /*#__PURE__*/React.createElement("iframe", {
    src: trueUrl,
    width: "100%",
    height: "100%",
    frameBorder: "0",
...
const ApplePlayer = ({
  ...
  return /*#__PURE__*/React.createElement(Player$1, null, /*#__PURE__*/React.createElement("iframe", {
    src: trueUrl,
    width: "100%",
    height: "100%",
    frameBorder: "0",
...
const DeezerPlayer = ({
  ...
  return /*#__PURE__*/React.createElement(Player$2, {
...
const Sponsors = () => {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(SponsorsHolderOpener, {
    onMouseEnter: () => setOpen(true),
    onClick: () => setOpen(true)
  }, "supported by"), /*#__PURE__*/React.createElement(SponsorsHolder, {
    open: open,
...
const ReferenceWrapper = styled.div`
  ...
  img {
    ...
    ${({
  isPreviewMobile
}) => isPreviewMobile && css(["margin-bottom:0.5rem;"])}
  }
  ...
  ${({
  isPreviewMobile
}) => isPreviewMobile && css(["max-width:50px;"])}
`;
const ReferenceTitle = styled.h2`
  ...
  ${({
  isPreviewMobile
}) => isPreviewMobile && css(["font-size:0.8rem;"])}
`;
...
const residenciesLogos = [{
  href: 'https://exil.cl',
  src: 'https://res.cloudinary.com/optune-me/image/upload/v1588226253/onescreener-v2/prod/ray-douglas/custom/exil_logo.jpg',
  alt: 'Exil, Zürich'
}, {
  href: 'https://www.mascotte.ch/',
  src: 'https://res.cloudinary.com/optune-me/image/upload/c_scale,f_auto,h_53,q_auto:best/v1588226156/onescreener-v2/prod/ray-douglas/custom/Mascotte.png',
  alt: 'Mascotte, Zürich'
}, {
  href: 'https://www.nachtseminar.ch/',
  src: 'https://res.cloudinary.com/optune-me/image/upload/v1588226155/onescreener-v2/prod/ray-douglas/custom/NachtSeminarLogo.svg',
  alt: 'Nachtseminar'
}, {
  href: 'https://www.plaza-zurich.ch/',
  src: 'https://res.cloudinary.com/optune-me/image/upload/v1588226253/onescreener-v2/prod/ray-douglas/custom/Plaza_Schwarz_ZH.png',
  alt: 'Plaza Club, Zürich',
  bigger: true
}, {
  href: 'https://www.trischli.ch/',
  src: 'https://res.cloudinary.com/optune-me/image/upload/c_scale,f_auto,q_auto:best,w_100/v1588226166/onescreener-v2/prod/ray-douglas/custom/trischli_white.png',
  alt: 'Trischli Club, St. Gallen'
}, {
  href: 'http://www.useit-party.ch/',
  src: 'https://res.cloudinary.com/optune-me/image/upload/c_scale,f_auto,q_auto:best,w_100/v1588226157/onescreener-v2/prod/ray-douglas/custom/use_it.png',
  alt: 'useit - Kaufleuten, Zürich'
}];
const References = ({
  isPreviewMobile
}) => {
  return /*#__PURE__*/React.createElement(ReferenceWrapper, {
    isPreviewMobile: isPreviewMobile
  }, /*#__PURE__*/React.createElement(ReferenceTitle, {
    className: "transparent",
    isFirst: true,
    isPreviewMobile: isPreviewMobile
  }, "Residencies"), residenciesLogos.map(({
    href,
    src,
    alt,
    bigger
  }, refIndex) => /*#__PURE__*/React.createElement(ReferenceLink, {
    key: `ref-${refIndex}`,
    className: "transparent",
    href: href || '#',
    target: href && href !== '#' ? '__blank' : '',
    bigger: bigger
  }, /*#__PURE__*/React.createElement(ReferenceImage, {
    src: src,
    title: alt
  }))));
};
...
const getBackgroundColor = ({
  ...
  selected,
  disabled
}) => disabled && BackgroundColor.disabled || selected && BackgroundColor.selectedGradient() || secondary && BackgroundColor.secondary || BackgroundColor.accent;

const getForegroundColor = ({
  secondary,
  selected,
  disabled
}) => disabled && ForegroundColor.disabled || selected && ForegroundColor.selected || secondary && ForegroundColor.secondary || ForegroundColor.accent;
...
const StyledButton = styled.button`
  ...
  ${({
  round
}) => round ? css(["line-height:40px;padding:0px;width:40px;overflow:hidden;"]) : css(["line-height:1.2;padding:16px;width:auto;overflow:none;"])};
  ...
  box-shadow: ${({
  shadow
}) => shadow ? '0 1px 3px 0 rgba(0,0,0,0.08), 0 1px 0 0 rgba(0,0,0,0.05), 0 0 0 1px rgba(0,0,0,0.05)' : 'none'};
  padding: 0.5rem 1rem;
  ...
  selected,
  disabled
}) => !selected && !disabled && css(["color:", ";background-color:", ";& svg{& *{fill:", ";stroke:", ";transition:fill 0.3s ease-out,stroke 0.3s ease-out;&[fill='none']{fill:none;}&[stroke='none']{stroke:none;}}}"], ForegroundColor.hover, BackgroundColor.hover, ForegroundColor.hover, ForegroundColor.hover)}
  }
...
/* eslint-disable react/prop-types */
const modalFadeIn = keyframes(["from{opacity:0;}to{opacity:1;}"]);
const modalFadeOut = keyframes(["from{opacity:1;}to{opacity:0;}"]);
const StyledModal = styled.div`
  position: ${({
  isSidePreview
}) => isSidePreview ? 'absolute' : 'fixed'};
  top: 0;
  left: 0;
  right: 0;
  bottom: 0;
...
const StyledTextContainer = styled(({
  isSidePreview,
  ...other
}) => /*#__PURE__*/React.createElement(SimpleBar, other))`
  margin-top: 0.5rem;
  margin-bottom: 0;
  width: 100%;
  padding-right: 15px;
...
const TextOverlay = ({
  ...
  }, /*#__PURE__*/React.createElement(ContentContainer, null, /*#__PURE__*/React.createElement(TextContainer, null, /*#__PURE__*/React.createElement(StyledTitle, null, label), /*#__PURE__*/React.createElement(StyledTextContainer, {
    isSidePreview: isSidePreview ? 1 : undefined
  }, content.split('\n').map((line, lineIndex) => /*#__PURE__*/React.createElement("p", {
    key: lineIndex
  }, line)))), /*#__PURE__*/React.createElement(StyledButtonContainer, null, /*#__PURE__*/React.createElement(StyledButton$1, {
    onClick: onClose
  }, "Close"))));
};
...
const BackgroundContainer = styled.div`
  ...
  background-size: ${({
  fullscreen
}) => fullscreen ? 'cover' : 'contain'};
  display: flex;
  z-index: 1;
`;

const areEqual = (prevProps, nextProps) => {
  var _prevProps$background, _nextProps$background;

  return prevProps.background.focusPoint === nextProps.background.focusPoint && prevProps.background.fullscreen === nextProps.background.fullscreen && ((_prevProps$background = prevProps.background.image) === null || _prevProps$background === void 0 ? void 0 : _prevProps$background.url) === ((_nextProps$background = nextProps.background.image) === null || _nextProps$background === void 0 ? void 0 : _nextProps$background.url);
};

const Background = /*#__PURE__*/React.memo(({
  background,
  getImageUrl
}) => /*#__PURE__*/React.createElement(BackgroundContainer, {
...
const TextContent = styled.div`
  ...
  ${({
  includeWidth
}) => includeWidth && css(["& > *{display:table-row;}"])}
  ${({
  adjustWidth
}) => adjustWidth ? css(["max-width:100%;"]) : css(["width:100%;"])}
...
const updateFontSize = (element, {
  ...
  const inBounds = () => {
    return parentHeight >= element.scrollHeight && (!includeWidth || parentWidth >= element.scrollWidth) && (isLogo || childrenFit({
      element
    }));
  };

  const grow = () => {
    fontSize += step; // Match criteria for currentFontSize

    if (fontSize >= fontSizeCandidate || fontSize >= maxFontSize) return; // Set new style

    element.style.fontSize = `${fontSize}px`; // Recursive shrink or grow
  ...
  const shrink = () => {
    fontSize -= step; // Match criteria for fontSizeCandidate

    if (fontSize <= minFontSize) return; // Set new style
...
class AutoTextFit extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ssrDone: false,
    ...
    this.TextRef = /*#__PURE__*/createRef();
  ...
  componentDidMount() {
    ...
    window.addEventListener('resize', this.setNewWindowSize); // Listen to parent element dimensions' change
  ...
  componentDidUpdate(prevProps) {
    ...
    const shouldResize = this.props.isMobileView !== prevProps.isMobileView || this.props.textValue !== prevProps.textValue || this.props.includeWidth !== prevProps.includeWidth;
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(TextContainer$1, {
    ...
    !isLogo && /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("br", null))));
  }
...
const getLogoPosition = ({
  ...
  const positionAlignmentDesktop = PositionTop.includes(positionDesktop) && 'top' || PositionBottom.includes(positionDesktop) && 'bottom' || 'center';
  const positionAlignmentMobile = PositionTop.includes(positionMobile) && 'top' || PositionBottom.includes(positionMobile) && 'bottom' || 'center';
  return {
...
const LogoText = ({
  ...
  return ((_logo$text = logo.text) === null || _logo$text === void 0 ? void 0 : _logo$text.title) ? /*#__PURE__*/React.createElement(LogoTextContainer, {
    size: logo.size,
    color: logo.text.color,
    isPreviewMobile: isPreviewMobile,
    logoPosition: logoPosition
  }, /*#__PURE__*/React.createElement(AutoTextFit, {
    adjustWidth: true,
    includeWidth: true,
    padding: "0",
    maxFontSize: 300,
...
}) => isDifferentPositions && css(["", ""], ({
  isPreviewMobile
}) => isPreviewMobile && css(["", ""], stylesLogoMobile))}


  ${({
  isPreviewMobile,
  padding
}) => css(["", ";"], isPreviewMobile ? padding.mobile : padding.desktop)}
`;
/*
...
const getLogoPadding = ({
  ...
  const logoPositionMobile = logo.isDifferentPositions && logo.positionMobile || logoPositionDesktop;
  const logoPadding = defineLogoPadding({
    isPreviewMobile,
    isSidePreview
  });
  const linkPosition = links.list.length > 0 ? links.position : '';
  const paddingIndexDesktop = linkPosition === 'CENTER_LEFT' && PositionLeft.includes(logoPositionDesktop) && 'left' || linkPosition === 'CENTER_RIGHT' && PositionRight.includes(logoPositionDesktop) && 'right' || PositionBottomLeft.includes(linkPosition) && PositionBottomLeft.includes(logoPositionDesktop) && 'bottom' || PositionBottomRight.includes(linkPosition) && PositionBottomRight.includes(logoPositionDesktop) && 'bottom' || 'none';
  const paddingIndexMobile = linkPosition === 'CENTER_LEFT' && PositionLeft.includes(logoPositionMobile) && 'left' || linkPosition === 'CENTER_RIGHT' && PositionRight.includes(logoPositionMobile) && 'right' || PositionBottom$1.includes(linkPosition) && PositionBottom$1.includes(logoPositionMobile) && 'bottom' || isPreviewMobile && 'bottom' || 'none';
  return {
...
const getLogoPosition$1 = ({
  logo
}) => {
  const positionDesktop = logo.positionDesktop > '' && logo.positionDesktop || logo.position;
  const classnameDesktop = positionDesktop > '' && positionDesktop.toLowerCase().replace('_', '-') || 'top-center';
  const logoPosition = logo.isDifferentPositions && logo.positionMobile || logo.positionDesktop || logo.position;
  const classnameMobile = logoPosition > '' && logoPosition.toLowerCase().replace('_', '-') || 'top-center';
  return {
    classnameMobile,
    classnameDesktop
  };
...
const LogoBox = ({
  ...
  const position = getLogoPosition$1({
    logo
  });
  const padding = getLogoPadding({
    logo,
    links,
    isPreviewMobile,
    isSidePreview
  ...
  return /*#__PURE__*/React.createElement(LogoContainer, {
    ...
    zIndex: zIndex,
    isPreviewMobile: isPreviewMobile,
    isDifferentPositions: (logo === null || logo === void 0 ? void 0 : logo.isDifferentPositions) || false,
    padding: padding
  }, logo.type === 'TEXT' ? /*#__PURE__*/React.createElement(LogoText, {
    logo: logo,
    isPreviewMobile: isPreviewMobileReady
  }) : ((_logo$image = logo.image) === null || _logo$image === void 0 ? void 0 : _logo$image.url) > '' && /*#__PURE__*/React.createElement(Logo, {
    logo: logo,
...
const FadeIn = keyframes(["from{opacity:0.1;}to{opacity:1;}"]);
...
const TextBox = ({
  ...
  return /*#__PURE__*/React.createElement(TextBackground, null, /*#__PURE__*/React.createElement(Text, {
    colorPrimary: color,
    colorAccent: colorAccent,
    wordWrap: wordWrap
  }, /*#__PURE__*/React.createElement(AutoTextFit, _extends({
    colorBackground: colorBackground,
...
const getUrl = (domain = 'https://api.optune.me') => ({
  slug,
  limit,
  includePast
}) => `${domain}/v2/events/${slug}.json?limit=${limit}&inclpast=${includePast}`; // *** TEST ***
...
// import { gigatools } from './gigatools.js'
// For now only OpTuNE is supported

const ApiProviders = {
  OPTUNE: optune // BANDSINTOWN: bandsintown,
  // GIGATOOLS: gigatools,
...
const transformVenue = ({
  ...
  const {
    ...
    name: null,
    city: null
  }].filter(venue => venue).reduce((acc, cur, idx) => idx === 0 && { ...acc,
    ...cur
  }, {
    name: 'unknown',
    city: 'unknown'
...
const fetchGigs = url => new Promise((resolve, reject) => {
  fetch(url).then(res => {
    try {
      resolve(res.json());
    } catch (error) {
...
const transformGigs = api => includeMonthTitle => events => {
  ...
  let previousYear = 0;
  let previousMonth = 0;
  events.map(api.transformEvent).map(transformVenue).sort((a, b) => a.startDate.date - b.startDate.date).forEach(event => {
...
const getGigs = async ({
  ...
  const data = await fetchGigs(api.url(gigsAPIDomain)({
    slug,
    limit,
    includePast
  })).catch(() => {
...
const GigsTitle = ({
  ...
  alignHorizontal,
  withLine
}) => /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(GigHead, {
  alignHorizontal: alignHorizontal
}, title), withLine && /*#__PURE__*/React.createElement("hr", {
...
const MonthItem = ({
  ...
  return /*#__PURE__*/React.createElement(Gig, {
    alignHorizontal: alignHorizontal
  }, /*#__PURE__*/React.createElement("hr", {
    className: "separator-line"
  }), /*#__PURE__*/React.createElement("b", null, month.month), ' | ', month.year);
};
...
const GigVenue = (title, venue) => title > '' ? `${venue.name || ''}${venue.name > '' && venue.city > '' && ', ' || ''}${venue.city || ''}` : venue.city || '';
...
const GigItem = ({
  ...
  return /*#__PURE__*/React.createElement(Gig, {
    alignHorizontal: alignHorizontal
  }, gigDate, ' | ', website ? /*#__PURE__*/React.createElement("a", {
    href: website,
    target: "_blank",
    rel: "noopener noreferrer"
  }, gigTitle) : gigTitle, gigVenue > '' && ' | ', gigVenue);
};
...
const GigsBox = ({
  ...
  const [gigs, setGigs] = useState(Array.isArray(gigsList) && gigsList.length > 0 ? {
    loading: false,
    data: gigsList
  } : {
    loading: true,
  ...
  const showGigs = !gigs.loading && !gigsLoading && gigs.data.length > 0; // Media Query

  const isSmall = useMediaQuery({
    query: MediaSmall
  });
  return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(InfoContainer, {
    color: color,
    alignHorizontal: alignHorizontal,
    active: !showGigs
  }, /*#__PURE__*/React.createElement(AutoTextFit, {
  ...
  }, /*#__PURE__*/React.createElement(GigsTitle, {
    alignHorizontal: alignHorizontal,
    color: color,
    title: gigsAPI.title,
    withLine: gigsAPI.includeMonthTitle
  }), /*#__PURE__*/React.createElement("p", null, gigs.loading || gigsLoading ? 'Loading events ...' : 'No events found'))), showGigs && /*#__PURE__*/React.createElement(TextBox, {
    alignHorizontal: alignHorizontal,
    color: color,
    colorAccent: colorAccent,
    colorBackground: colorBackground,
    ...
    alignHorizontal: alignHorizontal,
    title: gigsAPI.title
  }), /*#__PURE__*/React.createElement(GigList, null, gigs.data.map(({
    type,
    ...gig
  }, key) => type === Type.MONTH ? /*#__PURE__*/React.createElement(MonthItem, {
    key: key,
    month: gig,
    alignHorizontal: alignHorizontal
  }) : /*#__PURE__*/React.createElement(GigItem, {
    key: key,
    alignHorizontal: alignHorizontal,
    showDay: gigsAPI.includeMonthTitle,
    gig: gig
  }))), gigsAPI.includeShowMore && /*#__PURE__*/React.createElement(ShowMoreContainer, {
    alignHorizontal: alignHorizontal
...
const setMargin = el => {
  ...
  return el.style.margin = `${(parseInt(parentStyle.height) - parseInt(style.height)) / 2}px ${(parseInt(parentStyle.width) - parseInt(style.width)) / 2}px`;
};
...
class AutoPlayerFit extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ssrDone: false,
    ...
    this.setNewWindowSize = this.setNewWindowSize.bind(this);
    this.PlayerRef = /*#__PURE__*/createRef();
    this.resizeObserver = null;
  }
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(PlayerWrapper, {
      show: ssrDone && resized
    }, /*#__PURE__*/React.createElement(PlayerWrapperInner, {
      ref: this.PlayerRef
    }, children));
  }
...
AutoPlayerFit.defaultProps = DEFAULTS$1;
...
const MediaBox = ({
  ...
  let Player = ssrDone && (media === null || media === void 0 ? void 0 : media.url) && ReactPlayer;
  let url = (media === null || media === void 0 ? void 0 : media.url) || '';
  let format, autoplay, theme;

  if (media === null || media === void 0 ? void 0 : media.deezer) {
    format = media.deezer.format;
    autoplay = media.deezer.autoplay;
    theme = media.deezer.theme;
  }

  if ((media === null || media === void 0 ? void 0 : media.url.indexOf('spotify')) !== -1) {
    Player = SpotifyPlayer;
  } else if ((media === null || media === void 0 ? void 0 : media.url.indexOf('apple')) !== -1) {
    Player = ApplePlayer;
  } else if ((media === null || media === void 0 ? void 0 : media.url.indexOf('deezer')) !== -1) {
    Player = DeezerPlayer;
  }

  let PlayerWrapper = !!(media === null || media === void 0 ? void 0 : media.fullscreen) && Fullscreen || Player === ReactPlayer && AutoPlayerFit || Player !== ReactPlayer && (media === null || media === void 0 ? void 0 : (_media$deezer = media.deezer) === null || _media$deezer === void 0 ? void 0 : _media$deezer.format) === 'SQUARE' && !isPreviewMobile && AutoPlayerFit || Wrapper; // return (
  //   <PlayerWrapper>
  //     <Player
  //       url={url}
  //       playing={false}
  ...
  return (media === null || media === void 0 ? void 0 : media.fullscreen) ? Player && /*#__PURE__*/React.createElement(Fullscreen, null, /*#__PURE__*/React.createElement(Player, {
    url: url,
    playing: false,
    width: "100%",
    height: "100%",
    ...
    controls: true,
    isSidePreview: isSidePreview
  })) : Player && /*#__PURE__*/React.createElement(PlayerWrapper, {
    isPreviewMobile: isPreviewMobile
...
const CoverBox = ({
  ...
  return cover && !!((_cover$image = cover.image) === null || _cover$image === void 0 ? void 0 : _cover$image.url) && /*#__PURE__*/React.createElement(Cover, null, /*#__PURE__*/React.createElement(CoverLink, {
    href: cover.url || '',
    target: "__blank"
...
const renderHtml = text => typeof text == 'string' ? ReactHtmlParser(text) : '';
...
const getGridArea = ({
  ...
  const {
    ...
    RowSize,
    Unit
  } = DesktopGrid; // Decide if margin is calculated from top or bottom and left or right

  const isLeft = ColumnSize - endColumn >= startColumn - 1;
  const positionH = isLeft ? 'left' : 'right';
  const isBottom = RowSize - endRow < startRow - 1 || endRow === RowSize && ['BOTTOM_CENTER', 'BOTTOM_LEFT', 'BOTTOM_RIGHT'].includes(linksPosition);
  const positionV = isBottom ? 'bottom' : 'top'; // Calculate vertical and horizontal margins and width
  ...
  let marginVLinks = 0;
  let marginHLinks = 0;
  const linkMargin = isSidePreview ? LinkMarginSidePreview[linksSize] : LinkMargin[linksSize]; // Give extra margin if links are at same side as content
...
const getGridAreaMobile = ({
  ...
  const {
    ...
    RowSize,
    RowUnit
  } = MobileGrid; // Decide if margin is calculated from top or bottom and left or right

  const isLeft = ColumnSize - endColumn >= startColumn - 1;
  const positionH = isLeft ? 'left' : 'right'; // Calculate vertical and horizontal margins and width

  const marginHUnit = isLeft ? startColumn - 1 : ColumnSize - endColumn;
  let marginH = (marginHUnit * ColumnUnit).toFixed(3);
  const marginVUnit = RowSize - endRow;
  let marginV = (marginVUnit * RowUnit).toFixed(3);
  const linkMargin = endRow === RowSize ? LinkMarginMobile[linksSize] : 0; // Give extra margin if links are at same side as content
  ...
  marginV = isPreviewMobile ? `${Math.round(PreviewMobile.height * marginV) / 100}px` : `${marginV}%`;
  const area = `
...
const ResponsiveContainer = styled.div`
  ...
  isPreviewMobile,
  isSidePreview
}) => isPreviewMobile ? getGridAreaMobile(areaMobile, {
  linksSize,
  ...
  isPreviewMobile,
  isSidePreview
}) => !isSidePreview && getGridAreaMobile(areaMobile, {
  linksSize
}) || isPreviewMobile ? getGridAreaMobile(areaMobile, {
  linksSize,
  isPreviewMobile: true
...
const ContentBox = ({
  ...
  switch (type) {
    case 'COVER':
      Content = /*#__PURE__*/React.createElement(CoverBox, {
        cover: cover
      });
      break;

    case 'GIGS':
      Content = /*#__PURE__*/React.createElement(GigsBox, _extends({
        alignHorizontal: alignHorizontal,
        border: border,
        circle: circle,
        gigsAPI: gigsAPI,
    ...
    case 'MEDIA':
      Content = media ? /*#__PURE__*/React.createElement(MediaBox, {
        media: media,
        isPreviewMobile: isPreviewMobile,
        isSidePreview: isSidePreview
      }) : null;
    ...
    case 'TEXT':
      Content = /*#__PURE__*/React.createElement(TextBox, _extends({}, colors, {
        alignHorizontal: alignHorizontal,
        isPreviewMobile: isPreviewMobileReady,
        isSidePreview: isSidePreview,
        textValue: text,
  ...
  return fullscreen ? /*#__PURE__*/React.createElement(FullscreenContainer, null, Content) : /*#__PURE__*/React.createElement(ResponsiveContainer, {
    area: area,
...
const LinksList = styled.div`
  ...
  ${({
  isPreviewMobile
}) => isPreviewMobile ? css(["bottom:0 !important;justify-content:space-evenly !important;white-space:nowrap !important;"]) : css(["&.bottom-center{bottom:0;justify-content:center;white-space:nowrap;}&.bottom-left{bottom:0;justify-content:flex-start;white-space:nowrap;}&.bottom-right{bottom:0;justify-content:flex-end;white-space:nowrap;}&.center-right{right:0;width:auto;height:100%;flex-flow:column;justify-content:center;}&.center-left{left:0;width:auto;height:100%;flex-flow:column;justify-content:center;}"])}
`;
const LinksBox = ({
  children,
  position,
  ...
  zIndex: zIndex
}, /*#__PURE__*/React.createElement(LinksList, {
...
const toSquidInkIcon = (Icon, viewBox = '0 0 48 48') => {
  const SquidInkIcon = ({
    className
...
const AboutIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "notify"
}, /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
...
})), /*#__PURE__*/React.createElement("circle", _extends({}, defaultStrokeFill, {
  cx: "23",
  cy: "38",
  r: "2"
}))), '7 8 33 40');

const ArtoIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "arto"
}, /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  d: "M19.7780323,40.6750259c2.1686897,0,3.7365913,0.931488,4.9317913,2.9295158\r c0.7719879,1.3238602,2.5323544,3.532959,5.6963367,3.532959c1.5524807,0,3.2953014-0.5221024,5.1795483-1.5492935\r c0.882576-0.6853256,2.2165413-2.1963387,2.2973557-6.5055428c0.0366859-0.4152336,0.0494461-1.0372887,0.0648651-1.8108749\r c0.1079292-4.9955902,0.3636627-9.199522,2.3063927-9.8752766c0.3657913-0.5045567,0.913414-1.4652882,0.7863388-2.2340851\r c-0.0404053-0.2440376-0.162159-0.6103592-0.7416801-0.962328c-0.2908249-0.2195797-2.0756493-1.7598362-1.9842033-6.6820564\r c0.0866661-4.6234207,0.1722603-8.5593901,0.1722603-8.5593901c-0.0116959-0.1855545-0.3960953-6.0961533-4.6531906-6.0961533\r c-1.8204498,0-4.1289673,1.0112407-6.8649521,3.0092645L6.8275604,29.1542206l0,0\r c0.012229,0-2.5408611,4.0997238-1.014431,7.5640984c1.0463309,2.3792343,3.7881641,3.9987106,8.1531925,4.8164177\r c0.8490801-0.0664597,1.7231493-0.2450981,2.5685081-0.4152336C17.6066837,40.9004517,18.713623,40.6750259,19.7780323,40.6750259z\r M35.6245193,25.8339272c-1.5546112,0.0861301-2.9342957,0.0861301-2.9342957,0.0861301l-0.0015945-13.3486929\r c0,0-0.432251-3.5956993-3.8875885-1.1133213L10.5827618,32.8530617c0,0-1.2084913,1.7965202,0,2.1362572\r c0,0,1.2084913,0.943718,2.2452517,0.5141296c0.8634348-0.7682686,4.7488966-5.9898186,14.6799994-7.1339779\r c-0.0861301,5.1683865,0.0861301,12.4400654,0.0861301,12.4400654s2.7630997,2.9098434,5.4390068,0\r c0-2.9794922-0.086132-12.4650517-0.086132-13.6054897c0.1908684,0.0435982,0.9022446-0.1908703,2.7630997-0.4248047\r C35.7106514,26.7792416,37.1801949,26.3459263,35.6245193,25.8339272z M27.9701309,26c0,0-4.1617107,0.3029575-5.8024502,0.3827076\r c-1.6407394,0.0818768-0.4094505-0.7845306-0.4094505-0.7845306L28,18.6457176V26H27.9701309z"
}))));

const AwsIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "aws"
}, /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  d: "M1.9942529,10.785655L22,17.1971035v28.210474L2.2405748,38.721817L1.9942529,10.785655z M26.2818737,45.5L46,38.721817V10.9695177\r l-19.7132301,6.1361475L26.2818737,45.5z M23.9807243,13.8999424l18.1504478-5.904839L23.9807243,2.5L5.4131265,7.9951034\r L23.9807243,13.8999424z"
}))));

const AmazonIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "amazon"
}, /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement
578c0.6730728,1.131031,0.139679,3.4982147,1.3441963,3.7717257\r c2.4231491,0.5533476,1.2453995-3.7702656,1.3441925-5.7690368c0.0730019-1.4984698,0.7353668-2.4635448,0.4467697-3.5502884\r c-0.7840347-1.07117-1.9525375-0.5343683-2.6864433-0.4433603c-7.6203461,0.9422085-19.1934586,0.4433675-27.3189716,0.4433675\r c-0.9704285,0-2.6655154-0.4837542-3.3585391,0.6657703c-0.4686675,2.5628266,3.0300336,1.5033364,4.2540193,2.8845181\r c0.3980999,0.4492006,0.9864893,2.4333715,1.1198378,3.772212c0.3542995,3.5561285,0,8.9874125,0,14.2006674\r c0,5.508667,0.4180527,11.0655117,0,14.4225941c-0.1460018,1.1723938-0.8531399,3.0606918-1.1198378,3.3283615\r c-1.5257235,1.5242615-5.5587931-0.1640091-5.1509595,3.1069298C7.2792177,45.9987679,9.3320093,45.3495445,11.23734,45.2663193z"
}))));

const FacebookIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "facebook"
}, /*#__PURE__*/React.createElement("path", {
  id: "Facebook",
  fill: "none",
  ...
  strokeLinejoin: "round",
  strokeMiterlimit: "10",
  d: "M18,10.9089594C18,12.0681973,18,17,18,17h-5v8h5v21h9V25h6.8340988c0,0,0.599041-4,0.8893623-8C33.8908348,17,27,17,27,17s0-4.2918701,0-5.0815639C27,11.1272106,28.513258,10,29.5406246,10C30.5659466,10,33,10,35,10c0-1,0-5,0-8c-3,0-5.9853249,0-7.327034,0C17.6707039,2,18,9.7517662,18,10.9089594z"
})));

const FlickrIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "flickr"
}, /*#__PURE__*/React.createElement("circle", _extends({}, defaultStrokeFill, {
  cx: "11.8544006",
  cy: "24.1992188",
...
const GigsIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "gigs"
}, /*#__PURE__*/React.createElement("path", _extends({
  d: "M12.5036 37.9789H4.79167H4.34375H3V33.4366H4.79167M12.5036 8H4.79167V33.4366M12.5036 8H36.4964M12.5036 8V11.4262V30.27V33.4366H36.4964M36.4964 37.9789H44.2083H46V33.4366H44.2083M36.4964 8H44.2083V30.27V33.4366M36.4964 8V11.4262V33.4366M17.2165 13.9958H18.0734M18.9303 13.9958H18.0734M18.0734 13.9958V11.4262M21.5009 13.9958H22.3578M23.2147 13.9958H22.3578M22.3578 13.9958V11.4262M25.7853 13.9958H26.6422M27.4991 13.9958H26.6422M26.6422 13.9958V11.4262M30.0697 13.9958H30.9266M31.7835 13.9958H30.9266M30.9266 13.9958V11.4262M15.0743 11.4262H33.9257M36.4964 33.4366H12.4062H4.79167M36.4964 33.4366H44.2083M5.6875 32.5282L11.9583 26.169L5.6875 19.8099L11.9583 13.4507L5.6875 8.90845M11.9583 32.5282L5.6875 26.169L11.9583 19.8099L5.6875 13.4507L8.59896 11.1796L11.5104 8.90845M37.0417 32.5282L43.3125 26.169L37.0417 19.8099L43.3125 13.4507L37.0417 8.90845M43.3125 32.5282L37.0417 26.169L43.3125 19.8099L37.0417 13.4507L39.9531 11.1796L42.8646 8.90845M15.0743 40.25V36.6162H33.9257V40.25H15.0743Z"
}, defaultStrokeFill))));

const GithubIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id:
  d: "M38.9166679,13.5835094h-2.7510071c-1.1045685,0-2-0.8954306-2-2V8.8325033c0-1.1045694,0.8954315-2,2-2h2.7510071c1.1045685,0,2,0.8954306,2,2v2.7510061C40.9166679,12.6880789,40.0212364,13.5835094,38.9166679,13.5835094z"
})), /*#__PURE__*/React.createElement("path", _extends({
  fillRule: "evenodd",
  clipRule: "evenodd"
}, defaultStrokeFill, {
  d: "M37,19h4v18c0,2.2091408-1.7908592,4-4,4H11c-2.2091389,0-4-1.7908592-4-4V19h4"
}))));

const ITunesIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "itunes"
}, /*#__PURE__*/React.createElement("path", _extends({
  id: "iTunes"
}, defaultStrokeFill, {
...
const KikIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "kik"
}, /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  d: "M5,41.4933891\r V6.5066304C5,4.0166903,6.3082862,2,8.5004892,2C10.6907358,2,12,4.0166903,12,6.5066304v19.6877842l10.588583-10.6740351\r c1.1479244-1.2457037,2.4242363-2.0166903,3.8322525-2.0166903c2.1394024,0,3.6646595,1.9570436,3.6646595,4.0328903\r c0,1.5419731-0.6456337,2.7285213-1.7412472,3.9136028l-6.2191296,6.1082478l7.4835587,11.4445305\r c0.6785851,1.0677452,1.0020142,1.897892,1.0020142,2.9055023c0,2.4312706-1.7175961,4.0915604-3.7005539,4.0915604\r c-1.5649509,0-2.5014858-0.593029-3.4411392-2.0753593l-7.6133204-10.8510132L12,36.3355522v5.158329\r c0,2.4914055-1.3092642,4.5071182-3.4995108,4.5071182C6.3082862,46.0005112,5,43.9847984,5,41.4933891z M37.3181038,36.1693306\r c2.6322098,0,4.7657433-2.1457596,4.7657433-4.7921467s-2.1335335-4.792635-4.7657433-4.792635\r c-2.6326981,0-4.7662354,2.1462479-4.7662354,4.792635S34.6854095,36.1693306,37.3181038,36.1693306z"
}))));

const LastFMIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "lastfm"
}, /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  d: "M37.5164986,37.3455009c-4.6870003-0.019001-7.1844997-2.3269997-8.9204998-6.3934994l-0.4944992-1.1100006l-4.2810001-9.8220005c-1.4174995-3.4769993-4.9405003-5.8260002-8.9134998-5.8260002c-5.3759995,0-9.7375002,4.3915005-9.7375002,9.8074989c0,5.4165001,4.3614998,9.8079987,9.7375002,9.8079987c3.75,0,7.0130005-2.1349983,8.6389999-5.2654991l1.7320004,4.019001C22.8209991,35.5794983,19.0855007,37.5,14.9064999,37.5C7.5024996,37.5,1.5,31.4604988,1.5,24.0014992C1.5,16.5470009,7.5024996,10.5,14.9064999,10.5c5.5890007,0,10.1005001,3.0044994,12.3924999,8.3290005c0.1760006,0.4130001,2.4244995,5.7115002,4.3875008,10.220499c1.2159996,2.7915001,2.2514992,4.6419983,5.6139984,4.7565002c3.3030014,0.1139984,5.5699997-1.9099998,5.5699997-4.4689999c0-2.5-1.7285004-3.1009998-4.6469994-4.078001c-5.2439995-1.7399998-7.9540005-3.487999-7.9540005-7.6765003c0-4.0854998,2.7605-6.8099995,7.2469997-6.8099995c2.9230003,0,5.031498,1.309,6.4925003,3.9189997l-2.8670006,1.4744997c-1.0805016-1.5225-2.2705002-2.1234999-3.7859993-2.1234999c-2.1064987,0-3.607502,1.4744997-3.607502,3.4359999c0,2.7840004,2.4715004,3.2045002,5.9324989,4.3474998C44.3359985,23.3530006,46.5,25.0965004,46.5,29.4510002C46.5,34.0234985,42.6035004,37.3530006,37.5164986,37.3455009z"
}))));

const LinkedinIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "linkedin"
}, /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  d: "M45,28.4110813V44H35V29.4214535c0-3.5367546-1.0577316-5.950222-4.2244434-5.950222\r C28.3584633,23.4712315,27,25.958334,27,28.8042545V44h-9.5458603c0,0,0.1179066-25,0-27H27v5c0,0,2.541666-5.125,8-5\r C40.7574883,17.0000019,45,20.328104,45,28.4110813z M8.300477,3.5c-2.9934769,0-4.9516401,2.4123216-4.9516401,4.7485638\r C3.3488371,10.5339289,5.2503138,13,8.1843834,13h0.0585003c3.0515232,0,4.9493723-2.4656601,4.9493723-4.7514362\r C13.1346626,5.9123216,11.2944069,3.5,8.300477,3.5z M4,44h9V17H4V44z"
}))));

const MailIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "mail"
}, /*#__PURE__*/React.createElement("path", {
  fill: "none",
  strokeWidth: "2",
...
const MediumIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "medium"
}, /*#__PURE__*/React.createElement("path", {
...
const MessengerIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "messenger"
}, /*#__PURE__*/React.createElement("path", _extends({
...
}, defaultStrokeFill)), /*#__PURE__*/React.createElement("path", _extends({
...
const MixcloudIcon = ({
  ...
  stroke: "none",
  d: "M316,282.5c-1.8,0-3.6-0.5-5.2-1.6c-4.3-2.9-5.4-8.7-2.6-12.9c8.6-12.8,13.1-27.8,13.1-43.4c0-15.6-4.5-30.6-13.1-43.4c-2.9-4.3-1.7-10.1,2.5-12.9c4.3-2.9,10-1.7,12.9,2.5c10.7,15.9,16.3,34.5,16.3,53.8c0,19.3-5.6,37.9-16.3,53.8C321.9,281.1,319,282.5,316,282.5L316,282.5z"
})), /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("path", {
  stroke: "none",
  d: "M289.3,267.4c-1.8,0-3.6-0.5-5.2-1.6c-4.3-2.9-5.4-8.7-2.5-12.9c5.7-8.4,8.7-18.1,8.7-28.3c0-10.1-3-19.9-8.7-28.3c-2.9-4.3-1.8-10,2.5-12.9c4.3-2.9,10-1.8,12.9,2.5c7.8,11.5,11.9,24.9,11.9,38.7c0,13.9-4.1,27.3-11.9,38.7C295.3,266,292.3,267.4,289.3,267.4L289.3,267.4z"
})), /*#__PURE__*/React.createElement("path", {
  stroke: "none",
  d: "M245.8,184c-3.7-37.3-35.2-66.5-73.5-66.5c-31.7,0-59.8,20.4-69.9,50c-23.9,3.5-42.4,24.1-42.4,49c0,27.3,22.3,49.6,49.7,49.6h127.2c22.9,0,41.6-18.6,41.6-41.5C278.5,204.7,264.5,188.1,245.8,184z M236.9,247.5H109.7c-17.1,0-31.1-13.9-31.1-31c0-17.1,13.9-31,31.1-31c8.3,0,16.1,3.2,22,9.1c3.6,3.6,9.5,3.6,13.2,0c3.6-3.6,3.6-9.5,0-13.2c-6.4-6.4-14.3-10.8-22.9-13c8.8-19.4,28.4-32.4,50.3-32.4c30.5,0,55.3,24.8,55.3,55.2c0,5.9-0.9,11.7-2.8,17.3c-1.6,4.9,1,10.1,5.9,11.8c1,0.3,2,0.5,2.9,0.5c3.9,0,7.5-2.5,8.8-6.4c1.2-3.7,2.1-7.4,2.7-11.2c8.6,3.3,14.7,11.6,14.7,21.3C259.9,237.2,249.5,247.5,236.9,247.5z"
})));

const NewsletterIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "about"
}, /*#__PURE__*/React.createElement("path", _extends({
...
const PressKitIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "jack-2"
}, /*#__PURE__*/React.createElement("path", _extends({
  ...
  d: "M32 33H23V41H32V33Z"
}, defaultStrokeFill))));

const PandoraIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "pandora"
}, /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  d: "M37.9285774,5.5204482C35.2113647,3.1733198,31.4254551,2,26.6387997,2H7.7781734v1.5404708\r c6.0005531,0,6.7866774,1.026655,6.7866774,8.5060797v23.8330574c0,7.4799156-0.7856359,8.5789261-6.7866774,8.5789261v1.5404701\r h19.2903557v-1.5404701c-6.0020199,0-6.7881451-1.0990105-6.7881451-8.5789261v-9.1675377h6.3584156\r c4.7866554,0,8.5725651-1.1718521,11.2897778-3.4466267C40.6428604,20.9197826,42,17.9859943,42,14.3922119\r C42,10.8003874,40.6428604,7.8665991,37.9285774,5.5204482z M26.5684013,24.072588H20.280386V4.7137909h6.2875271\r c5.9296646,0,9.0736732,4.0318203,9.0736732,9.678421C35.6415863,20.0393028,32.4975777,24.072588,26.5684013,24.072588z"
}))));

const PicasaIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "picasa"
}, /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  d: "M17,35\r c0,0,25.9190979,0,26.6462669,0c-3.0782928,6.4166679-9.2732658,10.3522911-16.2128162,11H23.751194\r C21.5500546,45.7946625,19,45.2944832,17,44.3771553C17,44.0887909,17,35,17,35z M32,4\r c-3-1.3011808-4.900526-1.8271925-8.0375786-1.8271925c-2.6111259,0-5.1804104,0.5040126-7.6508045,1.4321752\r C16.8906212,4.1313958,31,17.3192158,32,18C32,16.9939213,32,4.3092251,32,4z M12.9772024,5.6086254\r C5.6186171,9.3918858,2.0479279,15.8527346,2.0479279,24.1321793c0,1.8855438,0.2839029,3.8027382,0.797168,5.7033787\r c0.5950758-0.5415096,18.0443764-16.3370647,18.4246979-16.684761\r C20.8987236,12.8138161,13.2255564,5.8350658,12.9772024,5.6086254z M13,42.886322c0-0.8575516,0-16.8693199,0-17.8807526\r c-1,0.6676331-8.8024483,8.0174484-9.0542107,8.2463264C5.7027726,37.6648102,8,40.4095955,13,42.886322z M35,5.3999496\r C35,6.2730846,35,31,35,31c1,0,9.2846794,0,9.6333542,0c0.8151855-2,1.087822-4.5894852,1.087822-7.048193\r C45.7211723,16.3205185,42,9.3765364,35,5.3999496z"
}))));

const PinterestIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id:
con = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "podcast"
}, /*#__PURE__*/React.createElement("circle", _extends({}, defaultStrokeFill, {
  cx: "24",
  cy: "18",
...
const PatreonIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "patreon"
}, /*#__PURE__*/React.createElement("path", _extends({
...
const QuoraIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "quora"
}, /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  d: "M34.165535,38.4112091c5.5694313-3.4936028,9.3750229-9.7391644,9.3750229-16.8652153\r c0-10.9476976-8.709034-19.8229942-19.5095749-19.8229942S4.4998765,10.5982962,4.4998765,21.5459938\r c0,10.9486771,8.7657967,19.8229942,19.5663376,19.8229942c1.5888901,0,2.9498005-0.1965332,4.4282017-0.5597763\r C30.350729,44.1864586,32,46.5766373,39,45.4341049V42.073967C39,42.073967,35.3378944,41.1059647,34.165535,38.4112091z\r M33,24.1669292c0,3.309782-0.7745056,6.3135166-2.4856186,8.5325871C28.3652229,30.4115124,25,28.530756,21,28.7703114v0.4018669\r v3.4940929c0,0,3.2298031,0.1148872,5.2146931,3.5263557c-0.7435989,0.2185326-1.9734097,0.3373337-2.7717648,0.3373337\r C17.9258118,36.5299606,13,30.9952469,13,24.1664391c0-0.8760891,0-4.2308464,0-5.1074257\r c0-6.8283157,4.4821529-12.3635216,9.9992676-12.3635216S33,12.2306976,33,19.0590134C33,19.9360828,33,23.2908401,33,24.1669292z"
}))));

const RedditIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "reddit"
}, /*#__PURE__*/React.createElement("ellipse", _extends({}, defaultStrokeFill, {
  cx: "24",
  cy: "28",
  rx: "20",
  ry: "14"
})), /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  d: "\r M24,13c0,0-0.166666-10.5,10-6"
})), /*#__PURE__*/React.createElement("circle", _extends({}, defaultStrokeFill, {
  cx: "39",
  cy: "9",
  r: "5"
})), /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  d: "\r M3.799078,24.8411064c-2.1213846-1.7678204-2.4080048-4.9206448-0.6401844-7.0420284s4.9206438-2.4080048,7.0420284-0.6401844"
})), /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  d: "\r M37.9304008,17.0772038c2.1494102-1.7336378,5.2972412-1.3965874,7.03088,0.7528229\r c1.7336349,2.1494083,1.3965874,5.2972412-0.7528229,7.0308781"
})), /*#__PURE__*/React.createElement("circle", _extends({}, defaultStrokeFill, {
  cx: "16",
  cy: "25",
  r: "2"
  ...
  d: "\r M16,32c0,0,7.833334,6.3333321,15,0"
}))));

const RequestFormIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "profile"
}, /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  strokeWidth: "0.68",
  ...
  fill: "#3A4B69"
}))), '0 0 29 22'); // import { MediaMobile } from '../../../style/media'
// const Size = {
//   Desktop: {
//     S: 12,
//     M: 14,
...
const SoundcloudIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "soundcloude"
}, /*#__PURE__*/React.createElement("path", _extends({
  fillRule: "evenodd",
  clipRule: "evenodd"
...
})), /*#__PURE__*/React.createElement("line", _extends({}, defaultStrokeFill, {
  x1: "20",
  y1: "36",
  x2: "20",
  y2: "13"
...
/* eslint-disable max-len, react/display-name, react/prop-types */
const SpotifyIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "spotify"
}, /*#__PURE__*/React.createElement("path", {
  fill: "none",
  strokeWidth: "2",
  strokeMiterlimit: "10",
  strokeLinejoin: "round",
  d: "M24,2C11.8,2,2,11.8,2,24c0,12.2,9.8,22,22,22c12.2,0,22-9.8,22-22C46,11.8,36.2,2,24,2z M34.1,33.7\r c-0.4,0.6-1.2,0.9-1.9,0.5C27,31,20.5,30.3,12.9,32.1c-0.7,0.2-1.5-0.3-1.6-1c-0.2-0.7,0.3-1.5,1-1.6c8.4-1.9,15.6-1.1,21.4,2.5\r C34.3,32.2,34.5,33.1,34.1,33.7z M36.8,27.7c-0.5,0.8-1.6,1.1-2.4,0.6c-5.9-3.6-14.9-4.7-21.9-2.6c-0.9,0.3-1.9-0.2-2.1-1.1\r c-0.3-0.9,0.2-1.9,1.1-2.1c8-2.4,17.9-1.3,24.7,2.9C37,25.9,37.3,26.9,36.8,27.7z M37,21.5c-7.1-4.2-18.8-4.6-25.6-2.5\r c-1.1,0.3-2.2-0.3-2.6-1.4c-0.3-1.1,0.3-2.2,1.4-2.6C18,12.7,31,13.1,39.1,18c1,0.6,1.3,1.8,0.7,2.8C39.3,21.8,38,22.1,37,21.5z"
})));

/* eslint-disable max-len */
const TechRiderIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "jack-2"
}, /*#__PURE__*/React.createElement("path", {
  fill: "none",
  strokeWidth: "2",
  strokeMiterlimit: "10",
  d: "M26,16.6000004V7l-0.2774048-1c0.2627659-0.451417,0.3706398-1.0046206,0.1827965-1.6021934c-0.2199955-0.6998515-0.8400688-1.2497916-1.5638504-1.3695009C23.0861359,2.8206689,22,3.7834423,22,5c0,0.3661499,0.1055908,0.704834,0.2774048,1L22,7v9.6000004C22,17.3731995,21.3731995,18,20.6000004,18h-0.0009441c-0.8467045,0-1.4996223,0.7457523-1.3877182,1.5850296l1.6266651,12.1999989C20.9307404,32.4805565,21.5240402,33,22.2257233,33h3.5485535c0.701683,0,1.2949829-0.5194435,1.3877201-1.2149715l1.6266651-12.1999989C28.9005661,18.7457523,28.2476482,18,27.4009438,18h-0.0009441C26.6268005,18,26,17.3731995,26,16.6000004z"
}), /*#__PURE__*/React.createElement("path", {
  fill: "none",
  strokeWidth: "2",
  strokeMiterlimit: "10",
  d: "M24,33c0,0-0.8808041,5.5934448,4,8c5.5537834,2.7383804,12.0292168,1.6175308,15,5"
}), /*#__PURE__*/React.createElement("path", {
  fill: "none",
  strokeWidth: "2",
  strokeMiterlimit: "10",
  d: "M15.0783405,17.0401802l-3.0308294-9.1090107l-0.578928-0.8612757c0.1068096-0.5112877,0.0345125-1.0702548-0.3323841-1.57796c-0.4296942-0.5946031-1.1916771-0.9206524-1.916234-0.8057332C7.963213,4.8855295,7.2365861,6.1419673,7.6206675,7.2963042c0.1155977,0.3474236,0.3227143,0.6354494,0.578928,0.8612752l0.052495,1.0364351l3.0308294,9.1090117c0.2441072,0.7336521-0.1527481,1.5262852-0.8864021,1.7703934l-0.0008955,0.0002975c-0.8034,0.2673149-1.1874828,1.1810589-0.8163328,1.9420815l5.3951502,11.062479c0.3075809,0.6306763,1.0345287,0.9362411,1.700325,0.7147102l3.3670635-1.1203194c0.6657963-0.2215271,1.0647564-0.9017143,0.9331646-1.5909481l-2.3082066-12.089592c-0.1587906-0.8316822-1.0137558-1.3331585-1.8171577-1.0658455l-0.0008945,0.0002975C16.1150799,18.1706886,15.3224478,17.7738342,15.0783405,17.0401802z"
}), /*#__PURE__*/React.createElement("path", {
  fill: "none",
  strokeWidth: "2",
  strokeMiterlimit: "10",
  d: "M18,34c0,0-0.5498009,3.7808762,10,5s10.8154068,8,10.8154068,8"
}), /*#__PURE__*/React.createElement("line", {
  fill: "none",
  strokeWidth: "2",
  strokeMiterlimit: "10",
...
const TiktokIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "tiktok"
}, /*#__PURE__*/React.createElement("path", {
  id: "tiktok1",
...
const TumblrIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "tumnlr"
}, /*#__PURE__*/React.createElement("path", _extends({
  id: "Tumblr"
}, defaultStrokeFill, {
  d: "M28.2993774,37.7747498c-0.7568913-0.4442291-2.1146793-1.208622-2.3918228-1.9455032C25.627409,35.0868607,25,33.5830879,25,30.9702377V20h11v-8H25V2h-5.1334782c-0.2881489,2.0465117-0.818922,3.7235594-1.5888195,5.2263365c-0.7713985,1.504777-2.3346605,2.534627-3.6103191,3.6091824C13.3977261,11.9080725,11.0465117,12.4786854,9,13.0489798V20h6v15.2144318c0,2.0610657,0.8481932,3.6338768,1.282917,4.7164345c0.4367256,1.081562,1.5314178,2.1065865,2.657999,3.0710869c1.1265812,0.9539909,2.6441803,1.6983757,4.2400036,2.2216492C24.774744,45.7413673,26.0790749,46,28.1551456,46c1.8259449,0,3.2625713-0.1840935,4.8388805-0.544281C34.5683441,45.0865288,36,44.4506989,38,43.5487366v-7.1031723c-2,1.4827652-4.2572517,2.2211494-6.556942,2.2211494C30.1488895,38.6672134,29.3078976,38.3695602,28.2993774,37.7747498z"
}))));

const viewBox = '0 0 52 52';
const TwitchIcon = toSquidInkIcon(() => {
  return /*#__PURE__*/React.createElement("g", {
    id: "twitch"
  }, /*#__PURE__*/React.createElement("path", {
    id: "twitch1",
    strokeWidth: "1",
    d: "M9.5,37h10v5c0,0.404,0.244,0.77,0.617,0.924C20.241,42.976,20.371,43,20.5,43c0.26,0,0.516-0.102,0.707-0.293L26.914,37\r H38c0.265,0,0.52-0.105,0.707-0.293l6.5-6.5C45.395,30.02,45.5,29.766,45.5,29.5V6c0-0.553-0.448-1-1-1h-35c-0.552,0-1,0.447-1,1\r v30C8.5,36.553,8.948,37,9.5,37z M10.5,7h33v22.086L37.586,35H26.5c-0.265,0-0.52,0.105-0.707,0.293L21.5,39.586V36\r c0-0.553-0.448-1-1-1h-10V7z"
  }), /*#__PURE__*/React.createElement("path", {
    id: "twitch2",
    strokeWidth: "1",
    d: "M50.5,0H5C4.644,0,4.315,0.189,4.136,0.496l-3.5,6C0.547,6.649,0.5,6.823,0.5,7v37c0,0.553,0.448,1,1,1h11v6\r c0,0.553,0.448,1,1,1h7c0.247,0,0.485-0.092,0.669-0.257L28.662,45H38c0.251,0,0.493-0.095,0.677-0.264l12.5-11.5\r c0.206-0.189,0.323-0.457,0.323-0.736V1C51.5,0.447,51.052,0,50.5,0z M49.5,32.062L37.61,43h-9.332\r c-0.247,0-0.485,0.092-0.669,0.257L20.116,50H14.5v-6c0-0.553-0.448-1-1-1h-11V7.271L5.574,2H49.5V32.062z"
  }), /*#__PURE__*/React.createElement("path", {
    id: "twitch3",
    strokeWidth: "1",
    d: "M21.5,28h4c0.552,0,1-0.447,1-1V14c0-0.553-0.448-1-1-1h-4c-0.552,0-1,0.447-1,1v13C20.5,27.553,20.948,28,21.5,28z\r M22.5,15h2v11h-2V15z"
  }), /*#__PURE__*/React.createElement("path", {
    id: "twitch4",
    strokeWidth: "1",
    d: "M31.5,28h4c0.552,0,1-0.447,1-1V14c0-0.553-0.448-1-1-1h-4c-0.552,0-1,0.447-1,1v13C30.5,27.553,30.948,28,31.5,28z\r M32.5,15h2v11h-2V15z"
  }));
}, viewBox);

const TwitterIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "twitter_1_"
}, /*#__PURE__*/React.createElement("path", _extends({
  id: "Twitter__x28_alt_x29_"
}, defaultStrokeFill, {
  d: "M40.8405876,20.3372402c2.4460297-0.2017784,4.1047821-1.3137436,4.7435074-2.8224907c-0.8826027,0.5419483-3.6213837,1.1327705-5.1340027,0.570015c-0.0740318-0.3551712-0.1567764-0.6929207-0.2380676-0.9977665c-1.152607-4.2320433-5.0986786-7.6414843-9.2334595-7.2297001c0.3343639-0.1350021,0.6735649-0.2608128,1.0122852-0.3735571c0.4548512-0.1630688,3.1254025-0.5975962,2.7049046-1.5402002c-0.3546867-0.8288918-3.6170254,0.6266289-4.2310734,0.8167944c0.8105049-0.3048458,2.1518307-0.8293762,2.2950573-1.7613344c-1.2421284,0.1703267-2.4615116,0.757761-3.4036331,1.6118145c0.340168-0.3662996,0.5980797-0.8124404,0.6527576-1.2929354c-3.3136349,2.1169891-5.2491665,6.3848391-6.8154964,10.5244589c-1.230032-1.1918049-2.320219-2.130537-3.2981491-2.651679c-2.7436161-1.471489-6.0238628-3.0063658-11.1733465-4.9181881c-0.1582298,1.7037525,0.8424406,3.9692936,3.7259007,5.4756222c-0.6246929-0.0837126-1.7671413,0.1030674-2.6807127,0.3217821c0.3721056,1.9519844,1.5871372,3.5599289,4.877059,4.3375301c-1.5034256,0.0991955-2.2805414,0.4412994-2.9845924,1.1787395c0.6846952,1.3572922,2.3555431,2.9550743,5.3614244,2.6270027c-3.3416967,1.4405193-1.3626156,4.1081657,1.3568096,3.7099323c-4.6389866,4.7914085-11.9528809,4.4396248-16.152504,0.4321041c10.9652767,14.9418316,34.8013611,8.8366718,38.35355-5.5554619c2.6608734,0.0227432,4.22575-0.9217968,5.1959343-1.9631138C44.2413177,21.0969372,42.0193253,20.827898,40.8405876,20.3372402z"
}))));

const YoutubeIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "youtube"
}, /*#__PURE__*/React.createElement("path", _extends({
  id: "YouTube"
}, defaultStrokeFill, {
  d: "M44.4285698,17.194952c0-3.4215393-2.7715721-6.194952-6.1912651-6.194952H9.1912718C5.7715716,11,3,13.7734127,3,17.194952v16.6100941C3,37.2265854,5.7715716,40,9.1912699,40h29.0460358c3.419693,0,6.1912651-2.7734146,6.1912651-6.1949539V17.194952z M19.5714283,33.6020012V18l11.8310776,7.8010006L19.5714283,33.6020012z"
}))));

const VimeoIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "vimeo"
}, /*#__PURE__*/React.createElement("path", _extends({
  id: "Vimeo"
}, defaultStrokeFill, {
...
const MiscShoppingIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "cart"
}, /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
...
const MiscCallIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("path", _extends({}, defaultStrokeFill, {
  d: "M44.301548,19.0324593\r c2.1602173-5.0219517,0.8455734-10.8719664-3.0950928-14.6611176c-0.8551483-0.8222678-1.4886818-1.423099-1.4886818-1.423099\r c-1.7698975-1.7698975-4.6394043-1.7698975-6.4093018,0l-2.7830811,2.7830811\r c-1.7698803,1.7698798-1.7698803,4.6394215,0,6.4093018l0.9068966,0.9068966\r c2.1743679,2.174366,3.0298023,5.3713932,2.1465435,8.3168278c-2.0833855,6.9475269-7.7182655,10.2208538-11.9738579,11.7357712\r c-2.9236641,1.0407753-6.1789799,0.3881569-8.4835987-1.6902485l-0.9807491-0.8844814\r c-1.7698975-1.7698975-4.6394043-1.7698975-6.4093018,0l-2.7830813,2.7830811\r c-1.7698797,1.7698784-1.7698798,4.6394234-0.0000002,6.4093018l1.4967251,1.496727\r c3.8993554,3.899353,9.8203888,5.0579262,14.8360291,2.7659187C24.1313705,41.7639313,29.4892406,37.8801422,34.3693848,33\r C38.8669624,28.5024223,42.3476868,23.5746841,44.301548,19.0324593z"
})), /*#__PURE__*/React.createElement("line", _extends({}, defaultStrokeFill, {
  x1: "14",
  y1: "33",
  x2: "5.5",
...
const MiscClockIcon = toSquidInkIcon(() => /*#__PURE__*/React.createElement("g", {
  id: "clock"
}, /*#__PURE__*/React.createElement("circle", _extends({}, defaultStrokeFill, {
  cx: "24",
  cy: "24",
  ...
  fontFamily: "'GothamRounded-Bold'",
  fontSize: "10"
}, "9"), /*#__PURE__*/React.createElement("text", {
  transform: "matrix(1 0 0 1 21 43)",
  fontFamily: "'GothamRounded-Bold'",
  fontSize: "10"
}, "6"), /*#__PURE__*/React.createElement("polyline", _extends({}, defaultStrokeFill, {
  points: "15,15 24,24 36,12"
})), /*#__PURE__*/React.createElement("circle", _extends({}, defaultStrokeFill, {
  cx: "24",
  cy: "24",
  r: "2"
...
const LinkWrapper = styled.a`
  ...
  cursor: ${({
  notInteractive
}) => notInteractive ? 'default' : 'pointer'};
`;
...
const Link = styled.div`
  ...
  box-shadow: ${({
  noShadow
}) => noShadow ? 'none' : '0 1px 3px 0 rgba(0, 0, 0, 0.08), 0 1px 0 0 rgba(0, 0, 0, 0.05), 0 0 0 1px rgba(0, 0, 0, 0.05)'};
  color: ${({
  color
}) => color};
  ...
  isPreviewMobile,
  size
}) => isPreviewMobile ? isSidePreview && ShapeSizeSidePreview.Mobile[size] || ShapeSize.Mobile[size] : isSidePreview && ShapeSizeSidePreview.Desktop[size] || ShapeSize.Desktop[size]};
  ...
  size,
  margin
}) => isPreviewMobile && (size === 'L' && (isSidePreview ? '0.5rem 0rem' : '2px') || '0.5rem 0.1rem') || margin || '0.5rem 0.35rem'};

  ${({
  isPreview
}) => isPreview && css(["@media (min-width:737px) and (max-width:991px){max-width:", ";max-height:", ";margin:", ";}"], ({
  size
}) => `calc(${ShapeSize.Mobile[size]} + 8px)`, ({
  size
}) => `calc(${ShapeSize.Mobile[size]} + 8px)`, ({
  size
}) => size === 'L' && '0.5rem 0.2rem' || '0.5rem')}

  @media ${MediaMobile} {
    pointer-events:none;
    width: ${({
  size
}) => ShapeSize.Mobile[size]};
    height: ${({
  size
}) => ShapeSize.Mobile[size]};
    margin: ${({
  ...
  &:hover(:focus) {
    ${({
  notInteractive
}) => !notInteractive && css(["background-color:", ";border-color:", ";color:", ";& .icon g{& path,line,circle,polygon,polyline,rect,ellipse{fill:", ";stroke:", ";&[fill='none']{fill:none;}&[stroke='none']{stroke:none;}}}"], ({
  colorBackgroundAccent
}) => colorBackgroundAccent, ({
  colorAccent
}) => colorAccent, ({
...
const LinkIconMapper = ({
  platform,
  size = 'M'
}) => styled(PlatformLinkIcon[platform])`
  width: ${({
  isSidePreview,
  isPreviewMobile
  ...
  ${({
  isPreview
}) => isPreview && css(["@media (min-width:737px) and (max-width:991px){max-width:", ";max-height:", ";}"], ({
  size
}) => IconSize.Mobile[size], ({
  size
}) => IconSize.Mobile[size])}
...
const PlatformLink = ({
  ...
  if (url > '') {
    ...
    return /*#__PURE__*/React.createElement(LinkWrapperText, {
...
const PlatformLinks = Object.keys(PlatformLinkIcon).map(platform => {
  const Icon = LinkIconMapper({
    platform
  });
...
const Links = ({
  ...
  const color = (linksColorState === null || linksColorState === void 0 ? void 0 : linksColorState.colorLinks) || links.colorLinks || content.color;
  const colorAccent = (linksColorState === null || linksColorState === void 0 ? void 0 : linksColorState.colorLinksAccent) || links.colorLinksAccent || content.colorAccent;
  const colorBackground = (linksColorState === null || linksColorState === void 0 ? void 0 : linksColorState.colorLinksBackground) || links.colorLinksBackground || content.colorBackground;
  const colorBackgroundAccent = (linksColorState === null || linksColorState === void 0 ? void 0 : linksColorState.colorLinksBackgroundAccent) || links.colorLinksBackgroundAccent || content.colorBackgroundAccent;
  return /*#__PURE__*/React.createElement(Fragment, null, links.list.filter(({
    platform,
    url
  }) => !!PlatformLinkIcon[platform]).map(link => /*#__PURE__*/React.createElement(PlatformLink, _extends({
    key: link.platform,
    border: links.border,
    circle: links.circle,
    square: links.square,
...
const transformation = {
  ...
  ssr: ({
    fullscreen = false
  }) => `q_auto:eco,f_auto,c_fit,w_1000,h_1000,e_pixelate:3`,
  ssrSocial: () => `q_auto:best,f_auto,c_fit,w_300,h_300`
};
const getImageUrl = (isClient, isSocial) => ({
  fullscreen,
  image,
  maxHeight = 100,
  maxWidth = 100
  ...
  if ((image === null || image === void 0 ? void 0 : image.url) > '') {
    ...
    if (isClient) {
      ...
      const windowWith = ((_window = window) === null || _window === void 0 ? void 0 : _window.innerWidth) || 1000;
      const windowHeight = ((_window2 = window) === null || _window2 === void 0 ? void 0 : _window2.innerHeight) || 1000;
      ...
      imageTransformation = transformation.client({
        width,
        height,
        fullscreen
      });
...
const PageContainer = styled.div`
  ...
  ${({
  isSidePreview
}) => isSidePreview && css(["box-shadow:-16px 3px 25px -22px rgba(255,255,255,0.7),16px 3px 25px -22px rgba(255,255,255,0.7),0 5px 8px 7px rgba(0,0,0,0.68),0 0 0 10px black;border-radius:", ";transition:border-radius 0.3s ease-out;"], ({
  isPreviewMobile
}) => isPreviewMobile ? '16px' : '6px')}
`;
const ForegroundContainer = styled.div`
  ...
  z-index: 2;
`;
const BacklinkUrl = 'https://res.cloudinary.com/optune-me/image/upload/v1598948675/onescreener-v2/app/back_link.png';
...
const Page = ({
  ...
  if (page) {
    ...
    const CustomHtml = (content === null || content === void 0 ? void 0 : content.customHTML) > '' ? customHtml[content.customHTML] : null;
    PageComponent = /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(GlobalStyle, null), /*#__PURE__*/React.createElement(PageContainer, {
      ...
      isPreviewMobile: isPreviewMobile,
      isSidePreview: isSidePreview
    }, ssrDone && /*#__PURE__*/React.createElement(Background, {
      background: background,
      getImageUrl: getUrl
    }), /*#__PURE__*/React.createElement(ForegroundContainer, null, !noBacklink && !isSidePreview && /*#__PURE__*/React.createElement(BackLink, {
      href: "https://www.onescreener.com",
      target: "_blank",
      title: "created with onescreener.com",
      isPreviewMobile: isPreviewMobile
    }, /*#__PURE__*/React.createElement("h1", null, "created by onescreener.com")), logo && /*#__PURE__*/React.createElement(LogoBox, {
      logo: logo,
      links: links,
      getImageUrl: getUrl,
      isPreviewMobile: isPreviewMobile,
      ...
      isPreviewMobileReady: isPreviewMobileReady,
      isSidePreview: isSidePreview
    }), links.list.length > 0 && /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(TextOverlay, {
      border: links.border,
      circle: links.circle,
      ...
      show: modalData.show,
      square: links.square
    }), /*#__PURE__*/React.createElement(LinksBox, {
      ...
      modalData,
      setModalData
    })))), CustomHtml && /*#__PURE__*/React.createElement(CustomHtml, {
      isPreviewMobile: isPreviewMobile
    })), page.isBlocked && /*#__PURE__*/React.createElement(BlockedCoverContainer, null, /*#__PURE__*/React.createElement(BlockedOverlay, null, "Page temporarily unavailable")));
  }
...
/* global window */
const CLOUDINARY_URL$1 = 'https://res.cloudinary.com/optune-me/image/upload';
...
const getFavionUrl = ({
  ...
  if ((image === null || image === void 0 ? void 0 : image.url) > '') {
    ...
    const imageSeparatorIndex = imageParts.findIndex(part => part === 'upload') + 1;
    const imagePath = imageParts.slice(imageSeparatorIndex);
    let imageTransformation = image.format === 'ico' ? '' : transformation$1.web();
    imageUrl = `${CLOUDINARY_URL$1}/${imageTransformation}${imagePath.join('/')}`;
  }

  return imageUrl;
};

export { ApplePlayer, DeezerPlayer, GlobalStyle, Links, Logo, MediaMobile, MediaSmall, NotMediaSmall, Page, PlatformLink, PlatformLinks, SpotifyPlayer, getFavionUrl, getGigs, getImageUrl, renderHtml };
