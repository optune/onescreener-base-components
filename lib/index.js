...
const MediaBox = ({
  ...
  let PlayerWrapper = !!(media === null || media === void 0 ? void 0 : media.fullscreen) && Fullscreen || Player === ReactPlayer && AutoPlayerFit || Player !== ReactPlayer && (media === null || media === void 0 ? void 0 : (_media$deezer = media.deezer) === null || _media$deezer === void 0 ? void 0 : _media$deezer.format) === 'SQUARE' && !isPreviewMobile && AutoPlayerFit || Wrapper;
  console.log({
    PlayerWrapper
  }); // return (
  //   <PlayerWrapper>
