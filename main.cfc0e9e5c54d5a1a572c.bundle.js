...
`,LogoBox=_ref=>{let{position:position,children:children}=_ref,other=_objectWithoutProperties(_ref,["position","children"]);return react_default.a.createElement(LogoContainer,_extends({className:""<position?position.toLowerCase().replace("_","-"):"top-center"},other),children)};LogoBox.displayName="LogoBox",LogoBox.__docgenInfo={description:"",methods:[],displayName:"LogoBox"},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/organisms/LogoBox.jsx"]={name:"LogoBox",docgenInfo:LogoBox.__docgenInfo,path:"src/components/organisms/LogoBox.jsx"});var prop_types=__webpack_require__(12),prop_types_default=__webpack_require__.n(prop_types);function AutoTextFit_objectWithoutProperties(source,excluded){if(null==source)return{};var key,i,target=function AutoTextFit_objectWithoutPropertiesLoose(source,excluded){if(null==source)return{};var key,i,target={},sourceKeys=Object.keys(source);for(i=0;i<sourceKeys.length;i++)key=sourceKeys[i],0<=excluded.indexOf(key)||(target[key]=source[key]);return target}(source,excluded);if(Object.getOwnPropertySymbols){var sourceSymbolKeys=Object.getOwnPropertySymbols(source);for(i=0;i<sourceSymbolKeys.length;i++)key=sourceSymbolKeys[i],!(0<=excluded.indexOf(key))&&Object.prototype.propertyIsEnumerable.call(source,key)&&(target[key]=source[key])}return target}const AutoFitTextContainer=styled_components_browser_esm.c.div`
  position: relative;
  width: 100%;
  height: 100%;
  display: flex;
